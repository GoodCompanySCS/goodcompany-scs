      ...
      <section style={{ backgroundColor: 'var(--cream)' }} className="section-padding">
        <div className="container-max">
          ...
          <div id="technology" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_female_technology_assistance.png"
                  alt="Senior woman getting help with a tablet"
                  width={320}
                  height={240}
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                ...
                <ul className="space-y-3 mb-6">
                  ...
                  <li className="flex items-start">
                    <span style={{ color: 'var(--sage)' }} className="font-bold mr-3">•</span>
                    <span><strong>Pantry & Fridge Organization:</strong> Organizing food items, checking expiration dates, and creating a kitchen that's easier to navigate and maintain.</span>
                  </li>
                  <li className="flex items-start">
                    <span style={{ color: 'var(--sage)' }} className="font-bold mr-3">•</span>
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_male_meals_and_nutrition.png"
                  alt="Senior man preparing food in the kitchen"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
          ...
          <div id="companion" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                <h2 style={{ color: 'var(--sage)' }} className="mb-4">Companionship & Wellness</h2>
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_female_companionship_and_check-ins.png"
                  alt="Two senior women enjoying a friendly visit over coffee"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
          ...
          <div id="errands" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_male_errands.png"
                  alt="Senior man receiving a grocery delivery at his door"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
          ...
          <div id="home" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_female_home_and_yard_services.png"
                  alt="Senior woman tending to her garden"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
          ...
          <div id="pet" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_male_pet_care.png"
                  alt="Senior man walking his dog on a sunny sidewalk"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
          ...
          <div id="paperwork" className="mb-8 pb-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-72 lg:w-80 flex-shrink-0">
                <Image
                  src="/images/services/Senior_female_paperwork_and_safety_support.png"
                  alt="Senior woman sorting through a pile of paperwork"
                  width={320}
                  height={240}
                  className="rounded-lg object-cover w-full"
                />
