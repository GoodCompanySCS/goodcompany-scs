      ...
      <section style={{ backgroundColor: 'var(--cream)' }} className="section-padding">
        <div className="container-max">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg mb-6">The idea for Good Company came from something much more personal. Like many families, Natalie has experienced firsthand the challenges that come with helping an aging parent remain independent. Her father lives over thirty minutes away, and while he is still capable and enjoys living on his own, there are times when a little extra help can make a big difference.</p>
            <p className="text-lg mb-6">At the same time, Natalie and her husband, Chris, have spent countless evenings walking the neighborhoods of Shelby Township for exercise. During those walks, they often found themselves stopping to help senior neighbors with everyday tasks that had gradually become difficult.</p>
